  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', 'Total Body Count', 'customers');
              createSection1('manage_worker.php', 'Total Number of Workers', 'workers');
        ...
        <hr style="border-top: 2px solid #0045f3;">
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('handshake', 'add_customer.php', 'Add New Body');
            createSection2('group', 'add_worker.php', 'Add New Worker');  
