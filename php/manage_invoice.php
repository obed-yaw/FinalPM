<?php
  ...
  function printInvoice($invoice_number) {
    ...
    <div class="row">
      ...
      <div class="col-md-10 h3" style="color: #0045f3;">Customer Invoice<span class="float-right">Invoice Number : <?php echo $invoice_number; ?></span></div>
    </div>
    ...
    <div class="row text-center">
      <hr class="col-md-10" style="padding: 0px; border-top: 2px solid  #0045f3;">
    </div>
    <div class="row">
      <div class="col-md-1"></div>
      <div class="col-md-4">
